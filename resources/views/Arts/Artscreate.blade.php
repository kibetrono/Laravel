...
<form style="background:#343a40;border-radius:25px;margin-top:10px" method="post" action="{{url('saveArts')}}" enctype="multipart/form-data">
@csrf
<div class="row"><!--row-->
  ...
  <div class="card shadow"><!--card shadow-->
                    <div class="card-header bg-info text-white"><!--card-header bg-info text-white-->
                        ...
                        <h1 style="border-top-right-radius:20px;border-top-left-radius:20px;text-align:center;background:#FFA500">Add more arts books...</h1><br/>
                        </div> <!--/card-title-->                      
