...
<html>
  ...
  <body style="background:#90EE90">
    <div class="container">
      ...
      <form style="background:#343a40;border-radius:25px;margin-top:10px" method="post" action="{{url('saveNovel')}}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 m-auto">
                <div class="card shadow">
                    <div class="card-header bg-info text-white">
                        ...
                        <h1 style="border-top-right-radius:20px;border-top-left-radius:20px;text-align:center;background:#FFA500">Inserting more novels...</h1><br/>
